...
class Farm(models.Model):
    ...
    created_by = models.ForeignKey(
        "auth.User", on_delete=models.CASCADE, verbose_name="Usuario"
    )
...
class ActivityType(models.Model):
    ...
    name_type = models.CharField(
        max_length=255, verbose_name="Nombre del tipo de actividad"
    )
...
class Activity(models.Model):
    ...
    activity_type = models.ForeignKey(
        ActivityType, on_delete=models.CASCADE, verbose_name="Tipo de actividad"
    )
...
class Supply(models.Model):
    """
    Modelo para representar un insumo o producto.
    """
